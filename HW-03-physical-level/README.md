...
### 10. Перезагрузка виртуальной машины
...
### 11. Проверка, что диск остается примонтированным
````
df -h
````
![img.png](img12.png)

### 12. Проверка статуса кластера
````
sudo -u postgres pg_lsclusters
````
![img.png](img13.png)

### 13. Перезапуск кластера и проверка содержимого ранее созданной таблицы
````
sudo -u postgres pg_ctlcluster 18 main stop
